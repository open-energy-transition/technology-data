...
Datasets are shipped in version-pinned directories — `dea_energy_storage/v10`, `legacy_input_data/v0.13.4` — and are selected with the `version` argument of `DataAccessor`.
