...
| [PyPSA technology-data input data](legacy_input_data.md) | `legacy_input_data` | `v0.13.4` | USA, World/Unspecified | Wide range of technologies from electricity generation, transmission and distribution, to storage and materials | CC-BY-4.0 |
