...
Each fact sheet follows the same structure: at a glance, versions, quick start, reproduce, contents, field mapping, naming conventions, assumptions and deviations from the source, known limitations, citation.
