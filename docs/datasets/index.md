...
Each fact sheet follows the same structure: at a glance, versions, accessing the data, contents, field mapping, naming conventions, assumptions and deviations from the source, reproduce, known limitations, citation.
