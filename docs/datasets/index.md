...
| [PyPSA technology-data manual inputs for the USA](legacy_input_data.md) | `manual_input_usa` | `v0.13.4` | USA | Electrolysis, batteries, CCS power plants, Fischer-Tropsch, direct air capture | CC-BY-4.0 |
