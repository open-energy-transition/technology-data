...
- [Danish Energy Agency parser](../examples/dea_storage_v10.md) and [Manual Input USA parser](../examples/legacy_data_v0134.md) — how each bundled catalogue is produced from its raw file.
