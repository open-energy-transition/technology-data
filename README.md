...
The package currently includes a pre-parsed data for the DEA's Technology Catalogue focusing on energy storage technologies and a dedicated parser (see [here](docs/examples/dea_storage.md)).  In the future it will include further common public data sources such NREL's ATB.
